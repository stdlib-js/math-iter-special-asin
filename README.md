...
```javascript
iterAsin = require( 'https://cdn.jsdelivr.net/gh/stdlib-js/math-iter-special-asin@v0.2.0-umd/browser.js' )
```

To vendor stdlib functionality and avoid installing dependency trees for Node.js, you can use the UMD server build:

```javascript
var iterAsin = require( 'path/to/vendor/umd/math-iter-special-asin/index.js' )
```

To include the bundle in a webpage,

```html
<script type="text/javascript" src="https://cdn.jsdelivr.net/gh/stdlib-js/math-iter-special-asin@v0.2.0-umd/browser.js"></script>
```
